...
if __name__ == "__main__":
    ...
    obs_name = "uGMRT" # you might include this as well in the command-line argument in future when we deal with other observatories. Te obsrvcoord file and the script is already prepared to take account of this
